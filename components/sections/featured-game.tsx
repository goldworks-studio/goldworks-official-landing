      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          <div className="relative rounded-2xl border border-border bg-card overflow-hidden">
            ...
            <div className="relative aspect-[21/9] bg-gradient-to-br from-blue-950/50 via-card to-cyan-950/30 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center gap-3 mb-4">
                      ...
                      <div className="w-12 h-px bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent" />
                      <Fish className="w-6 h-6 text-primary" />
                      <div className="w-12 h-px bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent" />
                      <Waves className="w-5 h-5 text-cyan-400 animate-pulse" />
                    </div>
                    <h3 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-foreground mb-2">
                      IDLE
                    </h3>
                    <p className="text-3xl md:text-4xl lg:text-5xl text-primary font-bold tracking-wide">
                      ANGLER
                    </p>
                    <div className="mt-6 flex items-center justify-center gap-4 text-muted-foreground">
                      <div className="flex items-center gap-2">
                        <Users className="w-4 h-4 text-cyan-400" />
                        <span className="text-sm uppercase tracking-wider">Multiplayer</span>
                      </div>
              ...
              <div className="absolute top-1/4 left-[15%] animate-[float_4s_ease-in-out_infinite]">
                <Fish className="w-8 h-8 text-primary/30 -rotate-12" />
              </div>
              <div className="absolute top-1/3 right-[20%] animate-[float_5s_ease-in-out_infinite_0.5s]">
                <Fish className="w-6 h-6 text-cyan-400/20 rotate-6" />
              </div>
              <div className="absolute bottom-1/3 left-[25%] animate-[float_3.5s_ease-in-out_infinite_1s]">
                <Fish className="w-5 h-5 text-primary/20 -rotate-6" />
              </div>

              {/* Corner decorations */}
              <div className="absolute top-6 left-6">
                <div className="w-12 h-12 border-l-2 border-t-2 border-cyan-400/30" />
              </div>
              <div className="absolute top-6 right-6">
                <div className="w-12 h-12 border-r-2 border-t-2 border-cyan-400/30" />
              </div>
              <div className="absolute bottom-6 left-6">
                <div className="w-12 h-12 border-l-2 border-b-2 border-cyan-400/30" />
              </div>
              <div className="absolute bottom-6 right-6">
                <div className="w-12 h-12 border-r-2 border-b-2 border-cyan-400/30" />
              </div>
            </div>
