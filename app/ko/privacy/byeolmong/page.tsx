...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${basePath}/ko/privacy/byeolmong/` },
  openGraph: {
    locale: "ko_KR",
    title: "별몽 개인정보 안내 | GoldWorks",
    url: `${basePath}/ko/privacy/byeolmong/`,
  },
};
  ...
  return (
    ...
    >
      <div className="legal-content deletion-content">
        <p>
          <Link href="/ko/privacy/">공통 개인정보처리방침 읽기</Link>
        </p>
        <section>
          <h2>별몽에서 처리하는 정보</h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            <Link href="/ko/privacy/#retention">공통 개인정보처리방침</Link>을
            확인해 주세요.
          </p>
          <p>
